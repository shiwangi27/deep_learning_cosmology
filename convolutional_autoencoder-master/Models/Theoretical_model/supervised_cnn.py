...
def build_conv_ae(input_var=None, use_dropout=False):
    ...
    # Apply 20% dropout to the input data: 
    l_dropout = lasagne.layers.DropoutLayer(l_dense_1, p=0.2)
...
if __name__ == '__main__': 
    ...
    if len(sys.argv) > 1:
        ...
        main(num_epochs = 500, sample_size=2000, batch_size = 128, learning_rate=3e-4, use_dropout=False, L2_lam = 1e-4, outfolder = 'Supervised_CNN') 
