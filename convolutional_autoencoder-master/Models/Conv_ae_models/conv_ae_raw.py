...
def load_data():
    ...
    def visualize_raw_data(train_x):
        ...
        plt.imsave('/global/homes/s/ssingh79/Output_files/training_x1_r.png', image)
        ...
        fig.savefig("/global/homes/s/ssingh79/Output_files/raw_hist_r.png")
        
        
    def visualize_normalized_data(train_x):
        # Visualize the normalized images. 
        print("Saving normalized training image ...........")
        plt.imsave('/global/homes/s/ssingh79/Output_files/normalized_x1_r.png', train_x[0][0])
        ...
        fig.savefig("/global/homes/s/ssingh79/Output_files/norm_hist_r.png") 
...
def main(num_epochs = 500):
    ...
    updates = lasagne.updates.nesterov_momentum(
            loss, params, learning_rate=0.005, momentum=0.6)
    ...
    fig.savefig("/global/homes/s/ssingh79/Output_files/learning_curve_r.png")
    ...
    plt.imsave('/global/homes/s/ssingh79/Output_files/ae_reconstruct_r.png', pred_images[0][0]) 
