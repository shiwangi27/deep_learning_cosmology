...
def load_data():
    ...
    def visualize_raw_data(train_x):
        ...
        plt.imsave('/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/training_x1.png', image)
        ...
        fig.savefig("/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/raw_hist.png")
        
        
    def visualize_normalized_data(train_x):
        # Visualize the normalized images. 
        print("Saving normalized training image ...........")
        plt.imsave('/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/normalized_x1.png', train_x[0][0])
        ...
        fig.savefig("/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/norm_hist.png") 
...
def build_conv_ae(input_var=None):
    ...
    conv_num_filter = 40
    filter_size = 5
    hidden_units = 28*28*40
    encode_size = 16*16*40
    ...
    # Add Third Convolution2D Layer -- (64, 28, 28) 
    ...
    # Encode layer: 
    encode = lasagne.layers.DenseLayer(l_hid1,
                                      num_units=encode_size,
                                      nonlinearity = lasagne.nonlinearities.tanh,
                                      W = lasagne.init.GlorotUniform())
    
    print("Encoded layer : ", encode.output_shape)
    ...
    print("Dense layer 2: ", l_hid2.output_shape)
    ...
    # Add the first Deconv layer -- (64, 28, 28) 
...
def main(num_epochs = 500):
    ...
    fig.savefig("/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/learning_curve.png")
    ...
    plt.imsave('/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/ae_reconstruct.png', pred_images[0][0]) 
