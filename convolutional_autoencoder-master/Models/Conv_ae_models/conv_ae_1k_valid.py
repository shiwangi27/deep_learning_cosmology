...
def load_data():
    ...
    def reshape_data(train_set):
        ...
        visualize_normalized_data(valid_x)
    ...
    def visualize_raw_data(train_x):
        ...
        plt.imsave('/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/valid/training_x1_1k_v.png', image)
        ...
        fig.savefig("/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/valid/raw_hist_1k_v.png")
        
        
    def visualize_normalized_data(train_x):
        # Visualize the normalized images. 
        print("Saving normalized training image ...........")
        plt.imsave('/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/valid/normalized_x1_1k_v.png', train_x[0][0])
        ...
        fig.savefig("/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/valid/norm_hist_1k_v.png") 
...
def build_conv_ae(input_var=None):
    ...
    # Add the First Deconv layer -- (64, 32, 32)
    ...
    # Add the Second Deconv layer -- (64, 64, 64)
...
def main(num_epochs = 500):
    ...
    fig.savefig("/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/valid/learning_curve_1k_v.png")
    ...
    plt.imsave('/global/homes/s/ssingh79/convolutional_autoencoder-master/output_files/valid/ae_reconstruct_1k_v.png', pred_images[0][0]) 
