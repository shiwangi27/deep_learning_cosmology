...
def build_conv_ae(input_var=None, use_dropout=False):
    ...
    # Add Second Convolution2D Layer -- (8, 32, 32)
    ...
    # Add the First Deconv layer -- (64, 64, 32)
    ...
    # Add the Second Deconv layer -- (128, 128, 1)
    ...
    return l_deconv_second, l_conv_second, l_conv_first   
...
if __name__ == '__main__': 
    ...
    if len(sys.argv) > 1:
        ...
        main(sample_size=1000, batch_size = 128, use_dropout=False, L2_lam = 0.0001, outfolder = 'Conv_ae_output_denoised_fl7')  
