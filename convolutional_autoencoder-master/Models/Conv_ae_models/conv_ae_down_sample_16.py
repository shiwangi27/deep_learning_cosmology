...
def build_conv_ae(input_var=None, use_dropout=False):
    ...
    conv_num_filter_2 = 16
    conv_num_filter_3 = 8 # Change from 4 to 8 
    ...
    # Add First Convolution2D layer -- (32, 64, 64)
    ...
    # Add Second Convolution2D Layer -- (16, 32, 32)
    ...
    # Add Third Convolution2D Layer -- (8, 16, 16) 
    ...
    l_deconv_first = lasagne.layers.Deconv2DLayer(l_conv_third,
                                                num_filters= conv_num_filter_2,
    ...
    return l_deconv_third, l_conv_third, l_conv_first   
...
if __name__ == '__main__': 
    ...
    if len(sys.argv) > 1:
        ...
        main(sample_size=100, batch_size = 80, use_dropout=False, L2_lam = 0.0001, outfolder = 'Conv_ae_output_downsample_test')  
