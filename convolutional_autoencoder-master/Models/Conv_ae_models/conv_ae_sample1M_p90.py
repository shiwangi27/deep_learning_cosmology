...
def build_conv_ae(input_var=None):
    ...
    l_in = lasagne.layers.InputLayer(shape=(None, 1, 90, 90),
                                     input_var=input_var)
...
if __name__ == '__main__': 
    ...
    if len(sys.argv) > 1:
        ...
        main(sample_size=10000, batch_size = 512, outfolder = 'Conv_ae_output_p90')  
