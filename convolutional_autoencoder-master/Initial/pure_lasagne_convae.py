...
def build_conv_ae(input_var=None):
    ...
    print("Shape after reshape : ", l_reshape_deconv.output_shape)
    ...
    print("Created Lasagne Layers ! ")
    print("Network Shape : ", l_deconv_third.get_output_shape)
...
def main(num_epochs = 500):
    ...
    plt.imsave('/global/homes/s/ssingh79/Output_files/ae_reconstruct.png', pred_images[0]) 
